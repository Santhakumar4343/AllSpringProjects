...
CREATE TABLE `loan_transaction` (
  ...
  `EMI` bigint NOT NULL,
  `SalaryCreditedDate` date NOT NULL,
  `approved_date` date NOT NULL,
  `loan_SantionedAmount` bigint NOT NULL,
  `tenure` int NOT NULL,
  `tenureremaining` int NOT NULL,
  `loan_Santioned_id` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKjfmfi6p6n9p4goedtuyr7f0ih` (`loan_Santioned_id`),
  CONSTRAINT `FKjfmfi6p6n9p4goedtuyr7f0ih` FOREIGN KEY (`loan_Santioned_id`) REFERENCES `loan_master` (`loan_Santioned_id`)
